...
data class AIAssistConfig(
    ...
    internal var deviceSecret: String,
    ...
    class Builder {
         ...
         */
        fun setXAipId(xAipId: String) = apply { this.xAipId = xAipId }

        /**
         * 设置设备唯一标识
         * @param xAipUid 设备唯一标识(sn,imei,mac)
         */
        fun setXAipUid(xAipUid: String) = apply { this.xAipUid = xAipUid }

        /**
         * 设置代理地址
         * @param xAipProxy 原始请求，包含主机名和端口
         */
        fun setXAipProxy(xAipProxy: String) = apply { this.xAipProxy = xAipProxy }
         ...
         */
        fun setSn(sn: String) = apply { this.sn = sn }
