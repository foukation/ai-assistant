...
public class ConfirmDialog{
    ...
    public ConfirmDialog setOnConfirmListener(Runnable listener) {
        (dialogView.findViewById(R.id.tv_dialog_ok)).setOnClickListener(v -> {
            listener.run();
            dialog.dismiss();
        });
        return this;
    ...
    public ConfirmDialog setOnCancelListener(Runnable listener) {
        (dialogView.findViewById(R.id.tv_dialog_cancel)).setOnClickListener(v -> {
            listener.run();
            dialog.dismiss();
        });
        return this;
    ...
    public ConfirmDialog setOkButtonVisibility(int visibility) {
        (dialogView.findViewById(R.id.tv_dialog_ok)).setVisibility(visibility);
        return this;
    }
    public ConfirmDialog setCancelButtonVisibility(int visibility) {
        (dialogView.findViewById(R.id.tv_dialog_cancel)).setVisibility(visibility);
        return this;
    }
}
