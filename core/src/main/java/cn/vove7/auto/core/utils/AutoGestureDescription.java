...
public final class AutoGestureDescription {
    ...
    private AutoGestureDescription(List<StrokeDescription> strokes) {
        this(strokes, Display.DEFAULT_DISPLAY);
    }

    private AutoGestureDescription(List<StrokeDescription> strokes, int displayId) {
    ...
    public static class TouchPoint implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<TouchPoint> CREATOR
    ...
    public static class GestureStep implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<GestureStep> CREATOR
